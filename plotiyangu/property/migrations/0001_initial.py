...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Contract',
            fields=[
                ('contract_id', models.CharField(editable=False, max_length=10, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            name='Tenant',
            fields=[
                ('tenant_id', models.CharField(editable=False, max_length=10, primary_key=True, serialize=False, unique=True)),
                ('first_name', models.CharField(max_length=30)),
                ('last_name', models.CharField(max_length=30)),
                ('email', models.EmailField(max_length=254, unique=True)),
                ('phone', models.CharField(max_length=15)),
        ...
        migrations.CreateModel(
            name='Payment',
            fields=[
                ('payment_id', models.CharField(editable=False, max_length=10, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            name='Unit',
            fields=[
                ('unit_id', models.CharField(editable=False, max_length=10, primary_key=True, serialize=False, unique=True)),
                ('description', models.TextField(blank=True, null=True)),
